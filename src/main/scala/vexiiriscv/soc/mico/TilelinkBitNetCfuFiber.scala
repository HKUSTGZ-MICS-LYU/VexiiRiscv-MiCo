...
class TilelinkBitNetCfuFiber(bitNetParam: BitNetCfuParameter, xlen: Int) extends Area {
  import TilelinkBitNetCfuFiber._
  ...
  val logic = Fiber build new Area {
    ...
    val cfu = new BitNetCfu(cfuParam, dBus.p, bitNetParam)
