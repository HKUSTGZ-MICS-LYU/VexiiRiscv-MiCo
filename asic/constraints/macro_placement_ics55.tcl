# Place ICS55 SRAM macros on the core7 site grid.
# The local tech LEF uses 1000 DBU/um, core7 is 0.2um wide by 1.4um high.
...
if {[llength $mico_macros] > 0} {
    ...
    foreach mico_inst $mico_macros {
        ...
        if {$mico_y + $mico_height > [$mico_core yMax]} {
            utl::error FLW 1 "ICS55 SRAM macros do not fit in the available core area"
        }
    ...
    utl::info FLW 1 "Placed [llength $mico_macros] ICS55 SRAM macros with dimension-aware packing"
}
